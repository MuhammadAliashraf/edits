                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isSelected
                        ? "border-stone-900/20 bg-muted/50 shadow-sm ring-1 ring-stone-900/5"
                    ...
                    <Link href={`/tasks/${task.id}`} className="flex-1 min-w-0">
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                        <div className="min-w-0">
                          <h3 className="truncate text-sm font-semibold text-stone-950 transition-colors group-hover:text-muted-foreground">
                            {task.source_title}
                          </h3>
          ...
          >
            ...
            <div className="flex items-center gap-2.5 pl-2 pr-3">
              <Checkbox
                ...
                className="border-stone-600 data-[state=checked]:bg-background data-[state=checked]:text-stone-950 data-[state=checked]:border-white data-[state=indeterminate]:bg-muted/500 data-[state=indeterminate]:border-stone-500"
              />
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className="text-stone-300 hover:text-white hover:bg-stone-800 disabled:text-muted-foreground disabled:hover:bg-transparent"
                  >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  disabled={activeBatchAction !== null}
                  className="text-muted-foreground hover:text-white hover:bg-stone-800 rounded-xl"
