                        ...
                        <div className="p-6 flex-1">
                          ...
                          {clip.text && (
                            <div className="mb-4">
                              ...
                              <p className="text-sm text-foreground/80 bg-muted/50 p-3 rounded">{clip.text}</p>
                            </div>
                          )}
                          {clip.reasoning && (
                            <div className="mb-4">
                    ...
                    <div className="p-6 flex-1">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          size="sm"
                          variant="outline"
                          className="text-red-600 hover:text-red-400 hover:bg-red-50 border-red-200"
                      ...
                      {editingClipId === clip.id && (
                        <div className="mt-4 p-3 border rounded-lg space-y-3 bg-muted/50">
