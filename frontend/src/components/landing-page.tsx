...
const HOSTED_APP_URL = "https://igedits.asal.life";
  ...
  return [
    {
      ...
      cta: "View on GitHub",
      ctaHref: "https://github.com/tass-55/Igedits",
      highlighted: false,
      isUnlimited: false,
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            ...
            <div>
              ...
              >
                ...
                <a
                  href="https://github.com/tass-55/Igedits"
                  target="_blank"
                ...
                <div className="bg-primary text-primary-foreground rounded-lg p-5 font-mono text-sm leading-loose overflow-x-auto">
                  <div>
                    ...
                    <span className="opacity-40">
                      https://github.com/tass-55/Igedits
                    </span>
                  </div>
                  <div>
                    <span className="opacity-50">$</span>{" "}
                    cd{" "}
                    <span className="opacity-40">igedits</span>
                  </div>
                  <div>
                    <span className="opacity-50">$</span>{" "}
                    docker-compose up -d
