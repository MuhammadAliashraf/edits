-- Database initialization script for IgEdits
...
CREATE TABLE generated_clips (
    ...
    -- Manual crop override for vertical clips: 'left' | 'center' | 'right' | NULL (auto face-detect)
    focus_side VARCHAR(10),

    -- Async focus re-render state: 'ready' | 'rerendering' | 'error'
    focus_status VARCHAR(20) NOT NULL DEFAULT 'ready',
    focus_error TEXT,
